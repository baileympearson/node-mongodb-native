...
## [7.0.0](https://github.com/baileympearson/node-mongodb-native/compare/v6.20.0...v7.0.0) (2025-10-20)


### ⚠ BREAKING CHANGES

* **NODE-6296:** remove cursor default batch size of 1000 ([#4729](https://github.com/baileympearson/node-mongodb-native/issues/4729))
* **NODE-7150:** update peer dependency matrix for 3rd party peer deps ([#4720](https://github.com/baileympearson/node-mongodb-native/issues/4720))
* **NODE-7046:** remove AWS uri/options support ([#4689](https://github.com/baileympearson/node-mongodb-native/issues/4689))
* **NODE-4808:** remove support for stream() transform on cursors and change streams ([#4728](https://github.com/baileympearson/node-mongodb-native/issues/4728))
* **NODE-6377:** remove noResponse option ([#4724](https://github.com/baileympearson/node-mongodb-native/issues/4724))
* **NODE-6473:** remove MONGODB-CR auth ([#4717](https://github.com/baileympearson/node-mongodb-native/issues/4717))
* **NODE-5994:** Remove metadata-related properties from public driver API ([#4716](https://github.com/baileympearson/node-mongodb-native/issues/4716))
* **NODE-7016:** remove `beta` namespace and move resource management into driver ([#4719](https://github.com/baileympearson/node-mongodb-native/issues/4719))
* **NODE-4184:** don't throw on aggregate with write concern and explain ([#4718](https://github.com/baileympearson/node-mongodb-native/issues/4718))
* **NODE-7043, NODE-7217:** adopt mongodb-client-encryption v7 ([#4705](https://github.com/baileympearson/node-mongodb-native/issues/4705))
* **NODE-6065:** throw MongoRuntimeError instead of MissingDependencyError in crypto connection ([#4711](https://github.com/baileympearson/node-mongodb-native/issues/4711))
* **NODE-6584:** improve typing for filepaths in AutoEncryptionOptions ([#4341](https://github.com/baileympearson/node-mongodb-native/issues/4341))
* **NODE-6334:** rename PoolRequstedRetry to PoolRequestedRetry ([#4696](https://github.com/baileympearson/node-mongodb-native/issues/4696))
* **NODE-7174:** drop support for Node16 and Node18 ([#4668](https://github.com/baileympearson/node-mongodb-native/issues/4668))
* **NODE-7047:** use custom credential provider first after URI ([#4656](https://github.com/baileympearson/node-mongodb-native/issues/4656))
* **NODE-6988:** require aws sdk for aws auth ([#4659](https://github.com/baileympearson/node-mongodb-native/issues/4659))

### Features

* **NODE-4179:** allow secureContext in KMS TLS options ([#4578](https://github.com/baileympearson/node-mongodb-native/issues/4578)) ([0ea6eaa](https://github.com/baileympearson/node-mongodb-native/commit/0ea6eaa82d56073f1a63d4168935d63a4a4e7a61))
* **NODE-4184:** don't throw on aggregate with write concern and explain ([#4718](https://github.com/baileympearson/node-mongodb-native/issues/4718)) ([88e02a4](https://github.com/baileympearson/node-mongodb-native/commit/88e02a41eaf69da100b2beeabc67a26406d4f2b7))
* **NODE-4808:** remove support for stream() transform on cursors and change streams ([#4728](https://github.com/baileympearson/node-mongodb-native/issues/4728)) ([1702987](https://github.com/baileympearson/node-mongodb-native/commit/17029879712f9af4e941203deb636af612c02c62))
* **NODE-5055:** Add databaseName property to command monitoring events ([#4586](https://github.com/baileympearson/node-mongodb-native/issues/4586)) ([3faf0c9](https://github.com/baileympearson/node-mongodb-native/commit/3faf0c967cd47b7fa6143aff914b4d2c47a584b3))
...
* **NODE-5545:** remove deprecated objects ([#4704](https://github.com/baileympearson/node-mongodb-native/issues/4704)) ([cfbada6](https://github.com/baileympearson/node-mongodb-native/commit/cfbada66ceb017bdb8fa1ff39257e1ab49ee9e25))
...
* **NODE-5994:** Remove metadata-related properties from public driver API ([#4716](https://github.com/baileympearson/node-mongodb-native/issues/4716)) ([b59c5ce](https://github.com/baileympearson/node-mongodb-native/commit/b59c5ce387714e3d3fc4eed20e882f4b56597dd0))
...
* **NODE-6065:** throw MongoRuntimeError instead of MissingDependencyError in crypto connection ([#4711](https://github.com/baileympearson/node-mongodb-native/issues/4711)) ([ff229fa](https://github.com/baileympearson/node-mongodb-native/commit/ff229fa8e4c906f5980ee4311c0eb0d883909934))
...
* **NODE-6296:** remove cursor default batch size of 1000 ([#4729](https://github.com/baileympearson/node-mongodb-native/issues/4729)) ([f8a855f](https://github.com/baileympearson/node-mongodb-native/commit/f8a855fcfcd0a2a0314c1eee89a8cf40dddebac1))
...
* **NODE-6334:** rename PoolRequstedRetry to PoolRequestedRetry ([#4696](https://github.com/baileympearson/node-mongodb-native/issues/4696)) ([84db848](https://github.com/baileympearson/node-mongodb-native/commit/84db84829fb41135d19bc5216137ef84a16a1960))
...
* **NODE-6377:** remove noResponse option ([#4724](https://github.com/baileympearson/node-mongodb-native/issues/4724)) ([9e9059a](https://github.com/baileympearson/node-mongodb-native/commit/9e9059a82f4886748cbecc8d36045f4fef6a4015))
...
* **NODE-6472:** findOne and find no longer keep open cursors ([#4580](https://github.com/baileympearson/node-mongodb-native/issues/4580)) ([be7f808](https://github.com/baileympearson/node-mongodb-native/commit/be7f808c3ff0d894906ec187de98e159ebb7b18d))
* **NODE-6473:** remove MONGODB-CR auth ([#4717](https://github.com/baileympearson/node-mongodb-native/issues/4717)) ([9a1bc65](https://github.com/baileympearson/node-mongodb-native/commit/9a1bc65893640f56b25049243ac94fc3dab35c8a))
...
* **NODE-6584:** improve typing for filepaths in AutoEncryptionOptions ([#4341](https://github.com/baileympearson/node-mongodb-native/issues/4341)) ([dab4c7c](https://github.com/baileympearson/node-mongodb-native/commit/dab4c7c8279ac1112d99d7ceca505632a45d0787))
...
* **NODE-6883:** allow rawData option on time series collections ([#4642](https://github.com/baileympearson/node-mongodb-native/issues/4642)) ([0fa3cd4](https://github.com/baileympearson/node-mongodb-native/commit/0fa3cd4e82b2b0d28a10bebca1dded2aa9324708))
...
* **NODE-6988:** require aws sdk for aws auth ([#4659](https://github.com/baileympearson/node-mongodb-native/issues/4659)) ([b7c6750](https://github.com/baileympearson/node-mongodb-native/commit/b7c6750771e0a578e7f2ce6a8b9192ee7e76e8d3))
...
* **NODE-7016:** remove `beta` namespace and move resource management into driver ([#4719](https://github.com/baileympearson/node-mongodb-native/issues/4719)) ([fb2824f](https://github.com/baileympearson/node-mongodb-native/commit/fb2824ffd503d0b8d580df3ee51bf40cc51f53e0))
* **NODE-7020:** remove ping on connect ([#4607](https://github.com/baileympearson/node-mongodb-native/issues/4607)) ([3d296b7](https://github.com/baileympearson/node-mongodb-native/commit/3d296b7d94810c3bc29153ffc3c8795f02699dd4))
* **NODE-7043, NODE-7217:** adopt mongodb-client-encryption v7 ([#4705](https://github.com/baileympearson/node-mongodb-native/issues/4705)) ([3f7196e](https://github.com/baileympearson/node-mongodb-native/commit/3f7196eb346925f2f6c016abfd18f030de25c911))
* **NODE-7046:** remove AWS uri/options support ([#4689](https://github.com/baileympearson/node-mongodb-native/issues/4689)) ([d14ac3f](https://github.com/baileympearson/node-mongodb-native/commit/d14ac3f66a7d17ece094568355a8e5b130c9926a))
* **NODE-7047:** use custom credential provider first after URI ([#4656](https://github.com/baileympearson/node-mongodb-native/issues/4656)) ([2a47bbb](https://github.com/baileympearson/node-mongodb-native/commit/2a47bbbf03ec54509d93f925d0747378e3de80ed))
* **NODE-7053:** deprecate noResponse option ([#4589](https://github.com/baileympearson/node-mongodb-native/issues/4589)) ([1115319](https://github.com/baileympearson/node-mongodb-native/commit/1115319a0913c136c688631a0cf9f6d3dfcb2e4c))
* **NODE-7059, NODE-7008:** add support for text queries for QE string fields ([#4597](https://github.com/baileympearson/node-mongodb-native/issues/4597)) ([e4492f3](https://github.com/baileympearson/node-mongodb-native/commit/e4492f3ff260a440ab4b2cb64ca90a68f9cf6fd5))
* **NODE-7125:** add db and client properties to collection and database objects ([#4640](https://github.com/baileympearson/node-mongodb-native/issues/4640)) ([3469f86](https://github.com/baileympearson/node-mongodb-native/commit/3469f86816e4b583a12de29d76b19823a3ad25ef))
* **NODE-7134:** allow hint with unacknowledged writes for delete, update and findAndModify commands ([#4647](https://github.com/baileympearson/node-mongodb-native/issues/4647)) ([82d6ce6](https://github.com/baileympearson/node-mongodb-native/commit/82d6ce6a6dbbf6d823f02c8d183fc1d45f0d1560))
* **NODE-7139:** remove pre-4.2 logic and deprecate dead code ([#4657](https://github.com/baileympearson/node-mongodb-native/issues/4657)) ([14303bc](https://github.com/baileympearson/node-mongodb-native/commit/14303bc810c1aa069d440ac3cd45bff354dc51aa))
* **NODE-7140:** deprecate driver info options ([#4654](https://github.com/baileympearson/node-mongodb-native/issues/4654)) ([b813c85](https://github.com/baileympearson/node-mongodb-native/commit/b813c85813c7c86b84aed1cdde69fc3e06856892))
* **NODE-7150:** update peer dependency matrix for 3rd party peer deps ([#4720](https://github.com/baileympearson/node-mongodb-native/issues/4720)) ([0451dae](https://github.com/baileympearson/node-mongodb-native/commit/0451dae9df3eaf3a0f85ac6e783a1da6bb31d1d3))
* **NODE-7157:** deprecate `retryWrites` in `CommandOperationOptions` ([#4661](https://github.com/baileympearson/node-mongodb-native/issues/4661)) ([620972d](https://github.com/baileympearson/node-mongodb-native/commit/620972df28f57aae1eb67dd2d3a49f8cf48f7262))
* **NODE-7174:** drop support for Node16 and Node18 ([#4668](https://github.com/baileympearson/node-mongodb-native/issues/4668)) ([a576b7d](https://github.com/baileympearson/node-mongodb-native/commit/a576b7d3a8210f0544c3814b130ea21585ea1f9f))
* **NODE-7223:** run checkout on connect regardless of credentials ([#4715](https://github.com/baileympearson/node-mongodb-native/issues/4715)) ([c5f74ab](https://github.com/baileympearson/node-mongodb-native/commit/c5f74abe27acd8661f17046b1740ac74de1be082))


### Bug Fixes

* **NODE-4763:** cache `resumeToken` in `ChangeStream.tryNext()` ([#4636](https://github.com/baileympearson/node-mongodb-native/issues/4636)) ([8331a93](https://github.com/baileympearson/node-mongodb-native/commit/8331a939c2f3d6833486ca3ec45cd77603cf3fa9))
...
* **NODE-6858:** treat MongoServerSelectionError as a resumable error for Change Streams ([#4653](https://github.com/baileympearson/node-mongodb-native/issues/4653)) ([c6d64e7](https://github.com/baileympearson/node-mongodb-native/commit/c6d64e71b010dbf2bc0dc634df12d7a03bd12da6))
...
* **NODE-7138:** prevent duplicate metadata from being appended to handshake metadata ([#4651](https://github.com/baileympearson/node-mongodb-native/issues/4651)) ([05c230c](https://github.com/baileympearson/node-mongodb-native/commit/05c230cb1b0cc5831983ad2fc8f84200a35da63d))
* **NODE-7232:** only send endSessions during client close if the topology supports sessions ([#4722](https://github.com/baileympearson/node-mongodb-native/issues/4722)) ([cc85ebf](https://github.com/baileympearson/node-mongodb-native/commit/cc85ebf246b20e0bae59e1bdcdf0f9c74ea01979))
